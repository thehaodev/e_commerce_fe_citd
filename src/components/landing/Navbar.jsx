...
const Navbar = ({ onLoginClick }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-md z-50 border-b border-gray-100 animate-fade-up">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <button onClick={handleLogin} className="text-gray-900 font-bold hover:underline">
              Log in
            </button>
            <button
